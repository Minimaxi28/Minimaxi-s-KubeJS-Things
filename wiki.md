...
## All available SoundEvent(s) are listed [here](https://mcsrc.dev/1/1.21.1/net/minecraft/sounds/SoundEvents)
...
// Replace `SOUND_EVENT_X` with any existing SoundEvent (https://mcsrc.dev/1/1.21.1/net/minecraft/sounds/SoundEvents).
