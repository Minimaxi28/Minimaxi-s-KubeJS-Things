...
StartupEvents.registry('block', event => {
  ...
  event.create("kubejs:budding")
    ...
    .tag('minecraft:mineable/pickaxe') // add the block to the tag "minecraft:mineable/pickaxe" so it's faster to mine with a pickaxe (though it'll still not drop anything)
