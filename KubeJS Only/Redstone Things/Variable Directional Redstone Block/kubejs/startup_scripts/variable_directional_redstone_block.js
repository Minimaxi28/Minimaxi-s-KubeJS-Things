StartupEvents.registry('block', event => {
  ...
  event.createCustom("kubejs:directional_variable_redstone_block", () => new JavaAdapter($NoteBlock, {
    ...
    /*neighborChanged*/"m_6861_"(blockState, level, blockPos, block, blockPos2, bl) {
      return;
    },
    /*updateShape*/"m_7417_"(blockState, direction, blockState2, levelAccessor, blockPos, blockPos2) {
      return blockState
    },
    /*attack*/"m_6256_"(blockState, level, blockPos, player) {
      return;
    },
    ...
    /*getStateForPlacement*/"m_5573_"(blockPlaceContext) {
    ...
    /*use*/"m_6227_"(blockState, level, blockPos, player, interactionHand, blockHitResult) {
      ...
      if(blockState.getValue($BlockStateProperties.NOTEBLOCK_INSTRUMENT) == $NoteBlockInstrument.FLUTE) {
        ...
        if(blockState.getValue($BlockStateProperties.NOTE) == 15) {
          ...
          level.setBlock(blockPos, blockState.setValue($BlockStateProperties.NOTE, $Integer['valueOf(int)'](0)), 3)
        } else {
